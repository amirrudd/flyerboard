    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                label: "In-the-area distance",
                suffix: "km from the chosen suburb",
                unit: "km",
                sparse: true,
                unsetNote: `Currently ${DEFAULT_NEAR_RADIUS_KM} km. Flyers further away are still shown — they sit below the "further away" line instead of above it.`,
            },
        ],
    },
    {
