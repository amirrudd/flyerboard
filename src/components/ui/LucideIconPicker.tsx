...
export function LucideIconPicker({ value, onChange, onClose }: LucideIconPickerProps) {
    ...
    if (isLoading) {
        return (
            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-8">
            ...
            <div className="p-2 border-b border-gray-100">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-md focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none"
                        autoFocus
                    />
                </div>
